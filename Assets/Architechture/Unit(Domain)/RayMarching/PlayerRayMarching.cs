...
public class PlayerRayMarching : MonoBehaviour
{
    ...
    public int[] OnRayMarchingUpdate((Transform transform, int objType, AlignedOBB obb)[] objectDataArray)
    {
    ...
    private Object ConstructObjectData((Transform transform, int objType, AlignedOBB obb) objectData)
    {
